...
const App = new class {
	...
	constructor() {
		...
		let obj = new ArmObject({position: new Vector2D(20, 25), size: new Vector2D(10, 2), angle: 0})
		this.simulation.objects.push(obj);
		...
		// let bucket = new BucketObject({position: new Vector2D(20 - bucketSize / 2, 25 - 3), size: new Vector2D(bucketSize, bucketSize)});
